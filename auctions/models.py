...
class Listing(models.Model):
    ...
    image_two = models.ImageField(upload_to="listing_images", default=None, blank=True)
    image_three = models.ImageField(upload_to="listing_images", default=None, blank=True)
