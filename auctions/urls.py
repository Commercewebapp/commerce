...
urlpatterns = [
    ...
    path(
        "remove_watchlist/<int:listing_id>",
    ...
    path(
        "each_category_listing/<int:category_id>",
        views.each_category_listing,
    ...
    path(
        "auto_close_listing",
        views.auto_close_listing,
        name="auto_close_listing",
    ),
    path("hot_listing_view", views.hot_listing_view, name="hot_listing_view"),
